      ...
      <div className="card deshabilitado-card">
        {loading ? (
          ...
          <>
            ...
            <h1 className="deshabilitado-titulo">Horario no laboral</h1>
          ...
          <>
            ...
            <div className="deshabilitado-body">
              <p>Tu cuenta se encuentra temporalmente deshabilitada. Esto puede deberse a mantenimiento del sistema, actualización de datos o un saldo pendiente de pago.</p>
              <p>Para solucionar esto y reactivar tus servicios, por favor ponte en contacto con nuestro equipo de soporte:</p>
            </div>
            <a
              href={WHATSAPP_URL}
              target="_blank"
