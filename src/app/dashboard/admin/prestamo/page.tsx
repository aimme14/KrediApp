  ...
  return (
    <div className="card">
      ...
      <p style={{ color: "var(--text-muted)", fontSize: "0.875rem", marginBottom: "1.25rem" }}>
        Selecciona el cliente, fecha de creación, frecuencia de pago, número de cuotas, interés y monto a prestar.
      </p>
      ...
      <form onSubmit={handleSubmit} className="card" style={{ marginBottom: "1.25rem" }}>
        ...
        <div className="form-group">
          ...
          <input
            ...
            min={1}
            value={numeroCuotas}
            onChange={(e) => setNumeroCuotas(parseInt(e.target.value, 10) || 1)}
            required
          />
        </div>
        <div className="form-group">
      ...
      <div className="card">
        <h3 style={{ marginTop: 0 }}>Préstamos recientes</h3>
        {loading ? (
          <p>Cargando...</p>
        ) : prestamos.length === 0 ? (
          <p style={{ color: "var(--text-muted)" }}>No hay préstamos registrados.</p>
        ) : (
