...
import { listRutas, listClientes, listPrestamos, listGastos } from "@/lib/empresa-api";
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const [rutas, empleados, clientes, prestamos, clientesMorosos, gastos] = await Promise.all([
          listRutas(token),
